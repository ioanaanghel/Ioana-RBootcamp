...
#from original snps file, pulls out only the data from the significant 
#   snips by calling on the names from the significant p-value vectors
#   
...
# Fit a linear model where the genotype is a single categorical variable (equivalent 
#   to one-way anova)
